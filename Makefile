...
CS333_TPROGS += _testsetuid  _testuidgid _p2-test _cpu_test _inher_test
endif

ifeq ($(CS333_PROJECT), 3)
CS333_CFLAGS += -DCS333_P1 -DUSE_BUILTINS -DCS333_P2 -DCS333_P3
CS333_UPROGS += _date _time _ps
CS333_TPROGS += _p2-test _testsetuid _testuidgid _allocate _roundRobin _processdeath _p3-test
endif

ifeq ($(CS333_PROJECT), 4)
CS333_CFLAGS += -DCS333_P1 -DUSE_BUILTINS -DCS333_P2 -DCS333_P3 -DCS333_P4
CS333_UPROGS += _date _time _ps
CS333_TPROGS += _testsetprio _p2-test _testsetuid _testuidgid _roundRobin _p4-priority _p4-test _p4-setprio
endif
